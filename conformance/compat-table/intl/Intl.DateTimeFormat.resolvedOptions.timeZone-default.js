...
// feature: DateTimeFormat
// subtest: resolvedOptions().timeZone defaults to the host environment
var __ok = (function () {var tz = Intl.DateTimeFormat().resolvedOptions().timeZone;
